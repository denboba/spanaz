  ...
  head: () => ({
    meta: [
      ...
      { title: "SPA NAZ | Masaj la Domiciliu în București" },
      {
        name: "description",
        content:
          "SPA NAZ oferă servicii profesionale de masaj la domiciliu în București. Relaxare, confort și o experiență personală direct la tine acasă.",
      },
      { name: "author", content: "SPA NAZ" },
      { property: "og:site_name", content: "SPA NAZ" },
